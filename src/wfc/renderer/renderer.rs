...
use octa_force::egui::{self, CollapsingHeader, Context, Pos2, ScrollArea, Ui, Vec2};
use petgraph::{csr::DefaultIx, graph::{EdgeIndex, NodeIndex}, visit::GraphRef, Directed};

use super::{drawers::{draw_counts_sliders, draw_section_debug, draw_simulation_config_sliders, draw_start_reset_buttons, ValuesConfigButtonsStartReset, ValuesConfigSlidersGraph, ValuesConfigSlidersSimulation, ValuesSectionDebug}, settings::{SettingsGraph, SettingsInteraction, SettingsNavigation, SettingsSimulation, SettingsStyle}};
...
impl WFCRenderer {
    ...
    pub fn gui_windows(&mut self, ctx: &Context) {
        ...
        egui::Window::new("WFC Graph Settings").show(ctx, |ui| {
        ...
        egui::Window::new("WFC Graph").show(ctx, |ui| {
...
fn init_force(settings: &SettingsSimulation) -> FruchtermanReingold<f32, 2> {
    FruchtermanReingold {
