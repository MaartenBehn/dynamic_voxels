...
use crate::{multi_data_buffer::buddy_buffer_allocator::BuddyBufferAllocator, util::{aabb3d::AABB, iaabb3d::AABBI}, volume::VolumeQureyPosValueI};

use super::{node::VoxelDAG64Node, DAG64EntryData, DAG64EntryKey, VoxelDAG64};


impl VoxelDAG64 {
    pub fn update_pos_query_volume<M: VolumeQureyPosValueI>(
        &mut self, 
        model: &M,
